...
public class UnaryOperator {
    public static void main(String[] args) {
        ...
        int a = 5;
        ++a;// pre increment- >will increase the value by 1 right away

        System.out.println(a);

        --a;// pre decrement--> will decrease the value by 1 right away;
        ...
        int x = 200;
        System.out.println( --x ); //pre decrement: --> will decrease the value by 1 right away;
