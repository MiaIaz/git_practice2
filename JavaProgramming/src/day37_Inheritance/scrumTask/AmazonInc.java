...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        ProductOwner po = new ProductOwner("Stuart", 29, 'M', 1, 67000, "Amazon Inc");

        BusinessAnalyst ba = new BusinessAnalyst("Cristian", 33, 'M', 232, 87000, "Amazon Inc");

        ScrumMaster sm = new ScrumMaster("Mia", 33, 'F',321, 76000, "Amazon Inc");
