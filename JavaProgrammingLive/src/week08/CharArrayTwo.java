...
public class CharArrayTwo {
    public static void main(String[] args) {
        ...
        int[] countOfEachChar = new int[26]; // I will turn a word into an array of
                                              // int where each char is stared to it's location
        /*
        word = acc;
        [1,0,2,0,0....]
        ASCII
        ...
        System.out.println("Are the words anagrams: " + Arrays.equals(countOfEachChar, emptyArray));
