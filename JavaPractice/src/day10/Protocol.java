...
public class Protocol {
    public static void main(String[] args) {
        ...
        int statusCode = 303;
        String codeMeanings =(statusCode == 200)?"Ok"
        ...
        System.out.println(codeMeanings);

    }
}
/*
7.  HTTP is the protocol that governs communications between
web-servers and web clients. Part of the protocol includes a
status code returned by the server to tell the browser the status
